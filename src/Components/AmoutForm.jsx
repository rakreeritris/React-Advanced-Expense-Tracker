...
await updateDoc(user, {
  creditAmount:typeofAmount==='CREDIT' ? amount+prevCreditAmount:prevCreditAmount,
  debitAmount:typeofAmount==='DEBIT' ? amount+prevDebitAmount:prevDebitAmount,
  ...
  <textarea onChange={(e)=>setMsg(e.target.value)} placeholder='Enter a short message...'></textarea>
